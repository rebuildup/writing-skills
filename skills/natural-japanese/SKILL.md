...
description: Use when writing, revising, or diagnosing Japanese reader-facing prose where naturalness, readability, translationese, repetitive AI-like patterns, Japanese sentence structure, or AI-written tone matter. Applies to reports, guides, minutes, memos, proposals, email, blogs, essays, and similar Japanese prose; layers on top of writing-discipline rather than replacing it.
license: MIT
